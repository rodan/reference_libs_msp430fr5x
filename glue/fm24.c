...
/*
uint8_t fm24_seek(const uint16_t usci_base_addr, const uint32_t addr)
{
    uint32_t c_addr;
    uint8_t i2c_buff[2];
    i2c_package_t pkg;
...
/*
uint32_t fm24_read(const uint16_t usci_base_addr, uint8_t * data, const uint32_t data_len)
{
    i2c_package_t pkg;
