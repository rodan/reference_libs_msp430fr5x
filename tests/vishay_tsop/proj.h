...
#define sig1_on              P1OUT |= BIT3
#define sig1_off             P1OUT &= ~BIT3
#define sig1_switch          P1OUT ^= BIT3

#define sig2_on              P1OUT |= BIT0
#define sig2_off             P1OUT &= ~BIT0
#define sig2_switch          P1OUT ^= BIT0
